      ...
      [this, client, endpoint_id = remote_device.GetEndpointId(),
       v3_info = std::move(info), connection_options, callback]() mutable {
        ...
        ConnectionListener listener = {
            .initiated_cb =
                [v3_initiated = std::move(v3_info.listener.initiated_cb),
                 endpoint_info](
                  ...
                  v3::InitialConnectionInfo new_info = {
                      ...
                      .is_incoming_connection =
                          ...
                          response_info.is_connection_verified,
                  };
                  v3::ConnectionsDevice device(endpoint_id, endpoint_info, {});
                  v3_initiated(device, new_info);
                },
            .accepted_cb =
                [result_cb = v3_info.listener.result_cb](
                    const std::string& endpoint_id) {
                  v3::ConnectionResult result = {
                      .status = {Status::kConnectionAccepted},
                  };
